...
function f7() {
    let myKey = document.querySelector('.i-7').value;
    for (let key in a7) {
        if (myKey == key) {
...
function f8() {
    let myKey = document.querySelector('.i-8').value;
    for (let key in a8) {
        if (myKey == key) {
            document.querySelector('.out-8').innerHTML = a8[myKey];
            break;
        }
        else {
...
function f9() {
    let myVal = document.querySelector('.i-9').value;
    let out = '';
    for (let key in a9) {
        if (myVal == a9[key]) {
            out += key + ' ';
...
function f11() {
    let myKey = document.querySelector('.i-11').value;
    delete a11[myKey];
    f5(a11, '.out-11');
}
...
function f12() {
    let myVal = document.querySelector('.i-12').value;
    for (let key in a12) {
        if (myVal == a12[key]) {
            delete a12[key];
        }
...
function f18() {
    let out = '';
    let myNum = document.querySelector('.i-18').value;
    for (let key in a18) {
        if (key == myNum) {
...
function f19() {
    let out = '';
    let myVal = document.querySelector('.i-19').value.trim().replace(/^\w/, (c) => c.toUpperCase());
    for (let key in a19) {
        for (let i = 0; i < a19[key].length; i++) {
            if (a19[key][i] == myVal) out += key;
        }
    }
