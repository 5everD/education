...
let ar1 = ['string', 17, 22, true, true, false, 'testotest'];
function f1() {
...
let ar2 = ['string2', 33, 56, true, false, 'testtesttest']
function f2() {
    // let out = '';
...
let ar3 = ['string3', 31, 54, false, false, '3_test']
function f3() {
    let out = '';
    out = ar3.length;
...
let ar4 = ['string4', 317, 524, false, false, '3_test', 5577, -9, true]
function f4() {
    let out = '';
...
// Вывод в out-6
// let ar6 =
let ar6 = ['Всеволод', 'близнецы', 14, 6];
function f6() {
    let out = '';
...
function f9() {
    let i = ar9.length - 1;
    document.querySelector('.out-9').innerHTML = ar9[i];
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = myCount;
}
