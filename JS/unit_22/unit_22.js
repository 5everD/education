...
function t3() {
    ...
    try {
        ...
        if (document.querySelector('out-3') == null) {
            let d = document.createElement('out-3');
            document.querySelectorAll('section')[2].appendChild(d);
            d.innerHTML = '<br>' + a * b;
        }
        else document.createElement('out-3').innerHTML = '<br>' + a * b
    }
}
